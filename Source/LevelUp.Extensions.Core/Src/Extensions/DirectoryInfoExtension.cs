...
public static class DirectoryInfoExtension
{
    ...
    public static IEnumerable<string> EnumerateFiles(this DirectoryInfo directoryInfo)
    {
        return EnumerateFiles(directoryInfo, "*.*");
    }

    public static IEnumerable<string> EnumerateFiles(this DirectoryInfo directoryInfo, string searchPattern)
    {
        return EnumerateFiles(directoryInfo, searchPattern, SearchOption.AllDirectories);
    }
    ...
    /// <returns></returns>
    public static IEnumerable<string> EnumerateFiles(this DirectoryInfo directoryInfo, string searchPattern, SearchOption searchOption)
    {
