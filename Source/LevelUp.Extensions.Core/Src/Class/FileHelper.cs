...
public static class FileHelper
{
    ...
    public static string GetAssociatedExeFile(string file)
	{
        return GetAssociatedExeFile(file, true);
	}

	public static string GetAssociatedExeFile(string file, bool throwException)
	{
